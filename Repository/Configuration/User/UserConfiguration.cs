...
public class UserConfiguration : IEntityTypeConfiguration<Domain.Data.Entities.User>
{
    public void Configure(EntityTypeBuilder<Domain.Data.Entities.User> builder)
    {
