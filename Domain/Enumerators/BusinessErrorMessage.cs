...
public enum BusinessErrorMessage
{
    ...
    [EnumDescription("COOPERATIVE_NOT_FOUND")]
    COOPERATIVE_NOT_FOUND = 29,

    [EnumDescription("COOPERATIVE_NOT_FOUND_OR_INVALID_PASSWORD")]
    COOPERATIVE_NOT_FOUND_OR_INVALID_PASSWORD = 30,

    [EnumDescription("COOPERATIVE_WITH_REPEAT_REGISTRATION_EMAIL")]
    COOPERATIVE_WITH_REPEAT_REGISTRATION_EMAIL = 31,

    [EnumDescription("COOPERATIVE_WITH_REPEAT_REGISTRATION_CPF")]
    COOPERATIVE_WITH_REPEAT_REGISTRATION_CPF = 32,
}
