...
public enum BusinessErrorMessage
{
    ...
    [EnumDescription("RESPONSIBLE_NOT_FOUND")]
    RESPONSIBLE_NOT_FOUND = 29,

    [EnumDescription("RESPONSIBLE_NOT_FOUND_OR_INVALID_PASSWORD")]
    RESPONSIBLE_NOT_FOUND_OR_INVALID_PASSWORD = 30,

    [EnumDescription("RESPONSIBLE_WITH_REPEAT_REGISTRATION_EMAIL")]
    RESPONSIBLE_WITH_REPEAT_REGISTRATION_EMAIL = 31,

    [EnumDescription("RESPONSIBLE_WITH_REPEAT_REGISTRATION_CPF")]
    RESPONSIBLE_WITH_REPEAT_REGISTRATION_CPF = 32,
}
