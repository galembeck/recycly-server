...
public interface ICooperativeAuthService
{
    ...
    Task<Tokens> RevokeAsync(string accessTokenId, string refreshTokenId, Cooperative actor, CancellationToken cancellationToken = default);
